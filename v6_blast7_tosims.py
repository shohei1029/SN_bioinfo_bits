...
class BLAST2SimMatrix(object):
    def __init__(self, input_file=None, cutoff_identity=0, edge_weight_thres=0):
        self.blast_file = input_file if input_file else None
        self.cutoff_identity = cutoff_identity
    ...
    def parse_blast_output(self):
        ...
        logger.info(f"cut off BLAST-hit by % identity < {self.cutoff_identity}")
        ...
        for line in in_fh:
            ...
            if identity < self.cutoff_identity:
                continue
